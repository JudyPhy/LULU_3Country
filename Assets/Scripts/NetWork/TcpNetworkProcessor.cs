...
public sealed class TcpNetworkProcessor {
    ...
    //拆包
    public void SplitPackage(byte[] buffer, int msgLength) {
        ...
        while (true) {
            ...
            byte[] array = { msgBuffer_[0], msgBuffer_[1], msgBuffer_[2], msgBuffer_[3] };  //包头前4个字节是消息长度（包头+内容）
            ...
            byte[] array2 = { msgBuffer_[4], msgBuffer_[5], msgBuffer_[6], msgBuffer_[7] };
