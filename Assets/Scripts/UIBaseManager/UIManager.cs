...
public class UIManager : MonoBehaviour {
    ...
    public void BackToMainUI() {
        ...
        //    return;
        //}
        //this.CloseMainWindow((eWindowsID)this.CurShowingWindow_.WindowData_.id);
        //this.ShowMainWindow<MainUI>(eWindowsID.MainUI);
    }
    ...
    public void SendMessageToWindow(eWindowsID windowId, WindowEvent windowEvent, params object[] args) {
        if (this.CurShowingWindow_.WindowData_._id == (int)windowId) {
            this.CurShowingWindow_.RevWindowEvent(windowEvent, args);
        }
    }
